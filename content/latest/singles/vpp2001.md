...
Offload (GSO). The VPP host stack supports GSO for TCP. At the driver level, VPP supports GSO
across vmxnet3 on esxi, linux tap devices, and vhost-user devices for virtualization.
